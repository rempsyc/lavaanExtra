...
2.  **Shorter code**. Because of point 1, you can have shorter code,
    ...
    patterns, you can also use
    [`paste0()`](https://rdrr.io/r/base/paste.html) with appropriate
    item numbers instead of typing each one every time.
...
[CFA example](#cfa-example)

[SEM example](#sem-example)
...
![](reference/figures/README-cfa2-1.png)
...
![](reference/figures/README-saturated-1.png)
...
![](reference/figures/README-covariance-1.png)
...
![](reference/figures/README-path2-1.png)
...
![](reference/figures/README-indirect2-1.png)
...
![](reference/figures/semplot2.png)
