...
```{r, message=FALSE}
visual <- HolzingerSwineford1939[names(HolzingerSwineford1939) %in% x[1:3]]
textual <- HolzingerSwineford1939[names(HolzingerSwineford1939) %in% x[4:6]]
speed <- HolzingerSwineford1939[names(HolzingerSwineford1939) %in% x[7:9]]
