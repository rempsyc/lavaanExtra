...
## lavaanExtra 0.2.2.5
* `nice_lavaanPlot()`: improve title, note, and fit statistics centering by adding ALIGN="CENTER" to HTML table cells and labeljust="c" to center the label horizontally in exported plots (PNG, PDF, JPG)
